                ...
                <xsl:otherwise>
                  ...
                  <xsl:choose>
                    ...
                    <xsl:when test="starts-with($Senderid,'EIF')">
                      <xsl:value-of select="string('warehouse@eif.co.nz')"/>
                    </xsl:when>
                  </xsl:choose>
                </xsl:otherwise>
              </xsl:choose>
              ...
              <xsl:otherwise>
                <Items json:Array='true'>
                  ...
                  <PackageType>
					...
					<xsl:choose>
                      <xsl:when test="substring-before(s0:Weight/text(),'.') !='' and substring-after(s0:Weight/text(),'.') !=''">
                         <WeightDead>
							<xsl:value-of select="concat(substring-before(s0:Weight/text(),'.'), '.',	substring(substring-after(s0:Weight/text(),'.'),0,3))"/>
						 </WeightDead>
                      </xsl:when>
					  <xsl:otherwise>
						<WeightDead>
