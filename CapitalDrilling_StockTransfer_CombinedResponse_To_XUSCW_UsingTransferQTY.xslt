        ...
        <Order>
          ...
          <OrderLineCollection>
            ...
            <xsl:for-each select="CWOrderResponse/ns0:UniversalResponse/ns0:Data/ns0:UniversalShipment/ns0:Shipment/ns0:Order/ns0:OrderLineCollection/ns0:OrderLine">
              ...
              <xsl:variable name="TransferQuantityFromST" select="../../../../../../../../StockTransferRcds/StockTransfers_Rcd/OrderLine[LineNumber=$LineNum]/StockTransfers_Rcd_Child17/text()" />
              <xsl:choose>
                <xsl:when test="$QuantityMetFromST">
                  <OrderLine>
                   ...
                   <QuantityMet>
                      <xsl:value-of select="$TransferQuantityFromST" />
                    </QuantityMet>
