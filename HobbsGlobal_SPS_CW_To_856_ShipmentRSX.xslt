      ...
      <xsl:for-each select="s0:Shipment">
        <Shipment>
          <Header>
            <ShipmentHeader>
              <TradingPartnerId>
                <xsl:value-of select="s0:CustomizedFieldCollection/s0:CustomizedField[s0:Key='TradingPartnerId' and s0:DataType='String']/s0:Value/text()"/>
              </TradingPartnerId>
          ...
          <OrderLevel>
            ...
            <xsl:variable name="OrderNum" select="s0:Order/s0:OrderNumber/text()" />
            <xsl:choose>
              <xsl:when test="s0:PackingLineCollection/s0:PackingLine">
              ...
              <xsl:otherwise>
                <xsl:for-each select="s0:Order/s0:OrderLineCollection/s0:OrderLine">
                  <PackLevel>
                    <Pack>
                      <PackLevelType>
                        <xsl:text>T</xsl:text>
                      ...
                      <ShippingSerialID>
                        <xsl:value-of select="concat($OrderNum,'-',position())"/>
                      </ShippingSerialID>
                    </Pack>
                    <PalletInformation>
                      <PalletQualifier>OU</PalletQualifier>
                      <PalletWeight>
                        <xsl:value-of select="../../../s0:CommercialInfo/s0:CommercialInvoiceCollection/s0:CommercialInvoice/s0:CommercialInvoiceLineCollection/s0:CommercialInvoiceLine[s0:OrderLineLink=s0:Link]/s0:Weight/text()"/>
                      </PalletWeight>
                      <PalletWeightUOM>
                        <xsl:value-of select="../../../s0:CommercialInfo/s0:CommercialInvoiceCollection/s0:CommercialInvoice/s0:CommercialInvoiceLineCollection/s0:CommercialInvoiceLine[s0:OrderLineLink=s0:Link]/s0:WeightUnit/s0:Code/text()"/>
